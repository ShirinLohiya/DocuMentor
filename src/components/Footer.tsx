      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            <Link to="/" className="flex items-center gap-2 mb-4">
              <Zap className="w-6 h-6 text-bolt-brightPurple" />
              <span className="font-bold text-lg">DocuMentor</span>
            </Link>
            <p className="text-muted-foreground mb-4">
              Transform any document into engaging, bite-sized training materials with our AI-powered platform.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="#" className="text-muted-foreground hover:text-foreground transition-colors">Testimonials</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-border pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} DocuMentor. All rights reserved.
          </p>
